...
class Attention(nn.Module):
    ...
    def forward(self, x):
        ...
        _, _, C, _ = q.shape  # C=30=180（dim）/6（num_head）
...
class HAB(nn.Module):
    r""" RTSB, similar to HAB in HAT-L
    ...
    def forward(self, x, x_size, rpi_sa, attn_mask):
        ...
        # Feed forward
        shortcut = shortcut.view(b, h, w, c)  # [1 h w 180]
...
class AttenBlocks(nn.Module):
    ...
    def __init__(self,
        ...
        #                     )
        self.overlap_attn = LSKblock(dim=dim)  # Replace OCAB with GCA
        # patch merging layer
...
class TTST(nn.Module):
    ...
    def __init__(self,
                 ...
                 in_chans=3,
                 embed_dim=180,
                 depths=(6, 6, 6, 6, 6, 6),  # (6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6),
        ...
        # build RTSG, borrows high-level architecture from Residual Hybrid Attention Groups (RHAG)
